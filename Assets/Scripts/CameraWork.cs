...
Only attach the CameraWork script on the local player.
Control the CameraWork behaviour by turning it off and on depending on whether the player it has to follow is the local player or not.
Have the CameraWork attached to the Camera and watch out for when there is a local player instance in the scene and follow that one only.
...
namespace com.MyCompany.MyGame
{
    ...
    public class CameraWork : MonoBehaviour
    {
        ...
        void Apply()
        {
            ...
            float currentAngle = cameraTransform.eulerAngles.x;
